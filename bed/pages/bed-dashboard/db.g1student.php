                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND sem.semester = '$_SESSION[active_semester]' AND remark = 'Approved' AND grade_level_id = '4' AND stud_type = 'New'") or die(mysqli_error($conn));
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        LEFT JOIN tbl_semesters AS sem ON sem.semester_id = sy.semester_id
                                                        LEFT JOIN tbl_acadyears AS ay ON ay.ay_id = sy.ay_id
                                                        WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND sem.semester = '$_SESSION[active_semester]' AND remark = 'Approved' AND grade_level_id = '4' AND stud_type = 'Old'") or die(mysqli_error($conn));
                                                        while ($row = mysqli_fetch_array($stud_count)) { ?>
                                                        <span
                                                            class="info-box-number"><?php echo $row['total_stud']; ?></span>
                                                        <?php } ?>
                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                ...
                                                LEFT JOIN tbl_acadyears AS ay ON ay.ay_id = sy.ay_id  
                                                WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND sem.semester = '$_SESSION[active_semester]' AND remark = 'Approved' AND sy.grade_level_id = '4'
