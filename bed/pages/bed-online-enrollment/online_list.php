                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                $get_user = mysqli_query($conn, "SELECT *, CONCAT(tbl_online_reg.student_lname, ', ', tbl_online_reg.student_fname, ' ', tbl_online_reg.student_mname) AS fullname FROM tbl_online_reg
                                                    LEFT JOIN tbl_grade_levels ON tbl_grade_levels.grade_level_id = tbl_online_reg.grade_level_id") or die (mysqli_error($conn)) ?>
                                                <tr>
                                                ...
                                                <?php
                                                $get_user = mysqli_query($conn, "SELECT *, CONCAT(tbl_online_reg_senior.student_lname, ', ', tbl_online_reg_senior.student_fname, ' ', tbl_online_reg_senior.student_mname) AS fullname FROM tbl_online_reg_senior
                                                    LEFT JOIN tbl_grade_levels ON tbl_grade_levels.grade_level_id = tbl_online_reg_senior.grade_level_id
                                                    LEFT JOIN tbl_strands ON tbl_strands.strand_id = tbl_online_reg_senior.strand_id") or die (mysqli_error($conn)) ?>
                                                <tr>
                                                    <?php while ($row = mysqli_fetch_array($get_user)) {
                                                        $id = $row['or_id'];
                                                    ?>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">Close</button>
                                                                        <a href="userData/ctrl.delonline_senior.php<?php echo '?or_id=' . $id; ?>"
                                                                            type="button" name="delete_senior"
                                                                            class="btn btn-danger">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
