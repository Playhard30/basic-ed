                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $get_user = mysqli_query($conn, "SELECT *, CONCAT(tbl_admit_online.student_lname, ', ', tbl_admit_online.student_fname, ' ', tbl_admit_online.student_mname) AS fullname FROM tbl_admit_online
                                                    LEFT JOIN tbl_grade_levels ON tbl_grade_levels.grade_level_id = tbl_admit_online.grade_level_id
                                                    LEFT JOIN tbl_strands ON tbl_strands.strand_id = tbl_admit_online.strand_id") or die (mysqli_error($conn)) ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<?php  if (empty($row['strand_id'])){ ?>
															<a href="admit_online_edit.php<?php echo '?ao_id=' . $id; ?>"
                                                            type="button"
														...
														<?php } else { ?>
															<a href="admit_online_edit_senior.php<?php echo '?ao_id=' . $id; ?>"
                                                            type="button"
                                                            class="btn bg-green text-sm p-2 mb-md-2"><i
                                                                class="fa fa-edit"></i>
                                                            Approve
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="userData/ctrl.delete_admit_online.php<?php echo '?ao_id=' . $id; ?>"
